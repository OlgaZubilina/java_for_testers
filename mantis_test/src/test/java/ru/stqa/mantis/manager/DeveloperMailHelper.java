    ...
    public String receive (DeveloperMailUser user, Duration duration){
        ...
        while (System.currentTimeMillis() < start + duration.toMillis()){
            ...
            try {
                ...
                if (!response1.success())throw new RuntimeException(response1.errors().toString());
                if (response1.result().size() >0){
                    ...
                    if (!response2.success())throw new RuntimeException(response2.errors().toString());
        ...
        throw new RuntimeException("Nj mail");
    }
